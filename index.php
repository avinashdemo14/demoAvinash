...
<h2 style="font-weight: bold;">Sample Code For Practice Azure CI/CD Pipelines</h2>
<?php echo "This is a php code dispalying current date-time ".date("Y-m-d H:i:s"); ?>
<span>
<h4 style="font-weight: bold;"> What is a portfolio ?</h4>
<p>
